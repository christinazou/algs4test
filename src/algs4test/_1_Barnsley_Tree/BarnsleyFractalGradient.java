...
public class BarnsleyFractalGradient {
    ...
    public static void main(String[] args) {
      ...
      //  StdDraw.setPenColor(green);
        ...
        double x = 0.5;
        double y = 0.0;
        int  colorx = (int) Math.round(255);
        int  colory = (int) Math.round(255);
        int  colorz = (int) Math.round(255);
        for (int i = 0; i < n; i++) {
            double tempx, tempy;
            double r = StdRandom.uniform(0.0, 1.0);
          colorx = (int) Math.round(255*(1-x));
          colory = (int) Math.round(255*(1-y));
          colorz = (int) Math.round(255*(1-r)*0.5);
            if (r <= 0.02)  {
                tempx = 0.5;
                tempy = 0.27 * y;   
            }
            ...
            x = tempx;
            y = tempy;
            Color temp = new Color(colorx, colory , colorz ); 
